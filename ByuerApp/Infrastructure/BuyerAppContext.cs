    ...
    public partial class BuyerAppContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Good>()
                .HasMany(g => g.Order)
                .WithMany(o => o.Good)
                .UsingEntity<GoodInOrder>(
            j => j
                .HasOne(pt => pt.Order)
                .WithMany()
                .HasForeignKey(pt => pt.IdOfOrder),
            k => k
                .HasOne(pt => pt.Good)
                .WithMany()
            ...
            j =>
                {
                    j.HasKey(t => new { t.IdOfGood, t.IdOfOrder });
                    j.ToTable("GoodInOrders");
                });
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                entity.Property(e => e.IdOfClient)
                    .HasColumnType("int")
                    .HasColumnName("IdOfClient")
                    .IsRequired();

                entity.HasOne(d => d.Customer)
                    .WithMany(p => p.Orders)
                    .HasForeignKey(d => d.IdOfClient)
